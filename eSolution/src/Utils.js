...
const availableApi = [
    ...
    { title: "PF Withdrawal", details: "Withdrawing Provident Fund (PF) isn’t as simple as withdrawing cash from a bank. Many employees face unexpected claim rejections, delays, and missing funds. If your EPF withdrawal is stuck or rejected, there’s always a reason, and we help you fix it. Enjoy the peace of mind while we handle these problems for you." },
    { title: "PF Transfer", details: "Transferring your Provident Fund (PF) can be complicated, especially with multiple UANs, unlinked accounts, or missing employer contributions. A smooth EPF transfer ensures your funds are consolidated into your latest EPF passbook, preventing claim rejections." },
    { title: "KYC", details: "EPFO meticulously verifies your details when you file a claim. Any mismatch in name, date of birth, Aadhaar, PAN, or mobile number can lead to PF claim rejection. We can assist you in getting all the necessary details corrected." }
]
